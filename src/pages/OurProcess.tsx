    ...
    return (
        <>
            <SEO 
                ...
                description="Discover how MH MARBLE merges ancient terrestrial materials with bleeding-edge robotic fabrication. Learn about our Digital Twin scanning and 5-axis robotic milling process." 
                breadcrumbs={[
                  { name: 'Home', item: '/' },
